require_relative "guidance/preparer"
require_relative "guidance/runner"
require_relative "guidance/outputter"
require_relative "guidance/silencer"
...
class Guidance
  ...
  attr_reader :vault, :args, :report

  def initialize(workdir)
    @vault = Vault.new('guidance', workdir)
